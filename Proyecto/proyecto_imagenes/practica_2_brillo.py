...
def ecualizacion(img):#obtiene la ecualizacion en escala de grises
    ...
    guardar_imagen(imagen_ecualizacion,ecualizacion,"ecualizacion.jpg")#se guardan los datos de la imagen nueva
...
def Grises1 (rutaimagen):
   ...
   imagenNegativo.save("Grises1.jpg")
   imagenNegativo.show()
...
def DesplazamientoGris(rutaimagen,desplazamiento):
    ...
    imgResultado.save("desplazamientoGris.jpg")
    imgResultado.show()
...
def ExpansionGris(rutaimagen):
    ...
    imgResultado.save("expansionGris.jpg")
    imgResultado.show()
