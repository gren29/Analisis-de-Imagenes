...
def suma_imagenes_grises(img_1,img_2):#obtiene la suma de dos imagenes en escala de grises
    ...
    guardar_imagen(imagen_suma,resultante,"suma_grises.jpg")#se guardan los datos de la imagen nueva
...
def resta_imagenes_grises(img_1,img_2):#obtiene la resta de dos imagenes en escala de grises
        ...
        guardar_imagen(imagen_resta,resultante,"resta_grises.jpg")#se guardan los datos de la imagen nueva
...
def resta_imagenes_rgb(img_1,img_2):#obtiene la resta de dos imagenes en escala de grises
        ...
        guardar_imagen(imagen_resta_rgb,resultante,"resta_rgb.jpg")#se guardan los datos de la imagen nueva
...
def ImagenNivelGrisOR(rutaImagenA,rutaImagenB):
    ...
    imagenC.show()
    imagenC.save("Imagen_nivelgris_OR.jpg")
...
def ImagenNivelGrisAND(rutaImagenA,rutaImagenB):
    ...
    imagenC.show()
    imagenC.save("Imagen_nivelgris_AND.jpg")
...
def ImagenColorOR(rutaImagenA,rutaImagenB):
    ...
    imagenC.show()
    imagenC.save("Imagen_color_OR.jpg")
...
def ImagenColorAND(rutaImagenA,rutaImagenB):
    ...
    imagenC.show()
    imagenC.save("Imagen_color_AND.jpg")
...
def ImagenBinariaOR(rutaImagenA,rutaImagenB):
    ...
    imagenC.show()
    imagenC.save("Imagen_binaria_OR.jpg")
...
def ImagenBinariaAND(rutaImagenA,rutaImagenB):
    ...
    imagenC.show()
    imagenC.save("Imagen_binaria_AND.jpg")

binarizar_imagen("imagenes/logo_pregunta.jpg",65)
