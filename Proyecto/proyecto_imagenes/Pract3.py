...
def FiltropromG(rutaimagen):
    ...
    imgResultado.save("filtropromG.jpg")
    imgResultado.show()
...
def FiltropromC(rutaimagen):
    ...
    imgResultado.save("filtropromC.jpg")
    imgResultado.show()
...
def FiltropromestandarpesadoG(rutaimagen, N):
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            g = g // (N + 8)
            imgResultado.putpixel((i,j),g)
    imgResultado.save("filtropromestandarpesadoG.jpg")
    imgResultado.show()
...
def FiltropromestandarpesadoC(rutaimagen, N):
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            pixel = tuple ([r, g, b])
            imgResultado.putpixel((i,j),pixel)
    imgResultado.save("filtropromestandarpesadoC.jpg")
    imgResultado.show()
...
def FiltroGaussianoG3(rutaimagen):
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            g = g // 16
            imgResultado.putpixel((i,j),g)
    imgResultado.save("filtroGaussianoG3.jpg")
    imgResultado.show()
...
def FiltroGaussianoC3(rutaimagen):
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            imgResultado.putpixel((i,j),pixel)
    imgResultado.save("filtroGaussianoC3.jpg")
    imgResultado.show()
...
def FiltroGaussianoG5(rutaimagen):
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            g = g // 246
            imgResultado.putpixel((i,j),g)
    imgResultado.save("filtroGaussianoG5.jpg")
    imgResultado.show()
...
def FiltroGaussianoC5(rutaimagen):
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            pixel = tuple ([r, g, b])
            imgResultado.putpixel((i,j),pixel)
    imgResultado.save("filtroGaussianoC5.jpg")
    imgResultado.show();
...
def FiltroMax(rutaimagen):
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            g = max(V)
            imgResultado.putpixel((i,j),g)
    imgResultado.save("filtroMax.jpg")
    imgResultado.show()
...
def FiltroMaxC(rutaimagen):
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            pixel = tuple([r,g,b])
            imgResultado.putpixel((i,j),pixel)
    imgResultado.save("filtroMaxC.jpg")
    imgResultado.show()
...
def FiltroMinC(rutaimagen):
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            pixel = tuple([r,g,b])
            imgResultado.putpixel((i,j),pixel)
    imgResultado.save("filtroMinC.jpg")
    imgResultado.show()
...
def FiltroMediana(rutaimagen):
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            g = Vo[4]
            imgResultado.putpixel((i,j),g)
    imgResultado.save("filtroMediana.jpg")
    imgResultado.show()
...
def FiltroMedianaC(rutaimagen):
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            pixeñ = tuple([r,g,b])
            imgResultado.putpixel((i,j),pixel)
    imgResultado.save("filtroMedianaC.jpg")
    imgResultado.show()
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            try:
                ...
                g = V[4]
            imgResultado.putpixel((i,j),g)
    imgResultado.save("filtroModa.jpg")
    imgResultado.show()
...
def FiltroModaC(rutaimagen):
    ...
    for i in range (ancho):
        for j in range (alto):
            ...
            pixel = tuple([r,g,b])
            imgResultado.putpixel((i,j),pixel)
    imgResultado.save("FiltroModaC.jpg")
    imgResultado.show()
#FiltroMediana("imagenes/foto_escala_grises.jpg")
FiltroMax("imagenes/Cuadros-Con-Ruido.jpg");
